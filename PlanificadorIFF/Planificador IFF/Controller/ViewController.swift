...
class ViewController: UIViewController {
    ...
    @IBAction func recognizeButtonAction(_ sender: Any) {
        ...
        if nil != self.imageView {
            let vi = VisionImage(image: imageView.image!)
    ...
    func scheduleFromPhoto(text: String) {
        ...
        if descanso != "" {
            ...
            //var firstDay = Int(descanso)! + 8
            textDetected.text = "Empiezas el dia " + firstDayStr
            textDet = "Empiezas el dia " + firstDayStr
        }
        else{
            textDetected.text = "Repite la foto puta"
            print("Descanso: ", descanso)
        }
